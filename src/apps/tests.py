...
from .models import App, Tag, Comment, NsRelease, Release, Download, Development, Maintenance, Installation
import datetime
...
class CommentTestCase(TestCase):
    ...
    def test_comment_created(self):
        ...
        self.assertEqual(comment.user.password, "b'user1pass'")
