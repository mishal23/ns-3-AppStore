...
class AppScreenshot(unittest.TestCase):
    def setUp(self):
    ...
    def test_app_screenshot(self):
        ...
        driver.find_element_by_id("id_screenshot").send_keys("C:\\fakepath\\Screenshot from 2019-11-08 13-51-30.png")
        driver.find_element_by_xpath("(.//*[normalize-space(text()) and normalize-space(.)='*'])[1]/following::button[1]").click()
        self.assertEqual("Screenshot added Successfully!", driver.find_element_by_xpath(u"(.//*[normalize-space(text()) and normalize-space(.)='← Go back to App Page'])[1]/following::h3[1]").text)
