...
class AppDownloadError(unittest.TestCase):
    def setUp(self):
    ...
    def test_app_download_error(self):
        driver = self.driver
        driver.get("http://localhost:8000/")
        driver.find_element_by_xpath("(.//*[normalize-space(text()) and normalize-space(.)='All Apps'])[1]/preceding::div[3]").click()
        ...
        driver.find_element_by_id("id_external_url").send_keys("")
