...
class AppRelease(unittest.TestCase):
    def setUp(self):
    ...
    def test_app_release(self):
        ...
        driver.find_element_by_xpath("(.//*[normalize-space(text()) and normalize-space(.)='Details'])[1]/following::b[1]").click()
        driver.find_element_by_link_text("Editor Actions").click()
        driver.find_element_by_link_text("Submit a new release").click()
        driver.find_element_by_id("id_version").click()
        driver.find_element_by_id("id_version").clear()
        driver.find_element_by_id("id_version").send_keys("0.5")
        driver.find_element_by_id("id_require").click()
        Select(driver.find_element_by_id("id_require")).select_by_visible_text("ns-3.28")
        driver.find_element_by_xpath("(.//*[normalize-space(text()) and normalize-space(.)='Requires ns-3 Version'])[1]/following::option[3]").click()
        driver.find_element_by_id("id_notes").click()
        driver.find_element_by_id("id_notes").clear()
        driver.find_element_by_id("id_notes").send_keys("None")
